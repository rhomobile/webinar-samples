    ...
    var actionsheet = (function() {
        ...
        var actionsheet = function(elID, opts) {
            ...
            try {
                ...
                $(elID).append('<div id="jq_action_mask" style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;z-index:9998;background:rgba(0,0,0,.8)"/>');
                setTimeout(function(){
...
(function($) {
    ...
    $(document).ready(function() {
        $("#jQUi").bind('touchstart', function(e) {
